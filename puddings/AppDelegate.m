...
- (void)createMainVC
{
    ...
    DIETimeLineViewController *timeLineVC = [[DIETimeLineViewController alloc] init];
    DIEDegeneratorViewController *degeneratorVC = [[DIEDegeneratorViewController alloc] init];
    DIERadioWaveViewController *radioWaveVC = [[DIERadioWaveViewController alloc] init];
    
    UINavigationController *centerNavCtrl = [[UINavigationController alloc] initWithRootViewController:centerVC];
    UINavigationController *timeLineNavCtrl = [[UINavigationController alloc] initWithRootViewController:timeLineVC];
    UINavigationController *degeneratorNavCtrl = [[UINavigationController alloc] initWithRootViewController:degeneratorVC];
    UINavigationController *radioWaveNavCtrl = [[UINavigationController alloc] initWithRootViewController:radioWaveVC];
    
    _mainTabBarCtrl = [[UITabBarController alloc] init];
    _mainTabBarCtrl.viewControllers = @[centerNavCtrl,timeLineNavCtrl,degeneratorNavCtrl,radioWaveNavCtrl];
